    ...
    <div>
      ...
      <form className="container mt-3 card  p-4" style={{ width: "400px" }}>
        ...
        <div className="form-group">
          ...
          <small>
            If item is Vegetables,Fruits and Egg, quantity must be a Number.
          </small>
        </div>
        ...
        <button
          className="btn btn-block btn-danger mb-4"
          type="submit"
          onClick={onResetData}
        >
          Reset
      ...
      <h1 className="col-12 mt-4">
        <span className="text-primary">Approximate Calories :</span> {calories}
      </h1>
    </div>
  );
};
